	...
	foreach($showcaseCollection as $singleCollection){ 
		...
		$productBlock = $this->getLayout()->createBlock('catalog/product_price');
			...
			<div class="grid_wrapper">
				<a href="'.$singleCollection->getLink().'?pj='.$singleCollection->getPjnumber().'" title="'.$singleCollection->getProductName().'"><img src="'.$imageUrl.'" alt="'.$singleCollection->getProductName().'"></a>

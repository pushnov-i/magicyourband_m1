...
class Elsner_Multicurrency_Model_Standard extends Mage_Paypal_Model_Standard
{
    ...
    public function canUseForCurrency($currencyCode)
    {
        ...
        if ($result == false) {
            $result = strpos(Mage::helper('multicurrency')->getConfig('extra_currencies'), Mage::app()->getStore()->getCurrentCurrencyCode());
        }
        return $result;
    }

...
class Sonassi_CatFix_Model_Catalog_Resource_Product_Type_Configurable_Attribute_Collection
    extends Mage_Catalog_Model_Resource_Product_Type_Configurable_Attribute_Collection
{

    protected static $_pricingCache = array();
    ...
    protected function _loadPrices()
    {
        ...
        if ($this->count()) {
            ...
            if (!Mage::app()->getStore()->isAdmin() && isset(self::$_pricingCache[$this->getProduct()->getId()])) {
                $values = self::$_pricingCache[$this->getProduct()->getId()];
            } else {
              ...
              self::$_pricingCache[$this->getProduct()->getId()] = $values;
            }            

...
;(function(root, factory) {
    ...
    var AnySlider = (function (slider, options) {
        ...
        if (options.showControls && orgNumSlides > 1) {
            slider.prepend('<a style="display:none" href="#" class="as-prev-arrow" title="LABEL">LABEL</a>'.replace(/LABEL/g, options.prevLabel));
            slider.append('<a style="display:none" href="#" class="as-next-arrow" title="LABEL">LABEL</a>'.replace(/LABEL/g, options.nextLabel));
        ...
        if (options.showBullets && orgNumSlides > 1) {
            var i,
                active,
                out = '<div style="display:none" class="as-nav"></div>',
                nav = $(out);

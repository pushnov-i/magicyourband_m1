...
window.OneStep.$(document).ready(function($){
    OneStep.Views.Payment           = Backbone.View.extend({
        ...
        hdlChangeMethod: function(ev){
            ...
            view_onestep_init.update({"updatepaymentmethod":true});
            return true;
        },
        ...
        updateOrder: function(){
            ...
            if(
                window.OneStep.$('input[name=payment\\[method\\]]:checked').val() == "sagepaydirectpro" ||
                    ...
                    window.OneStep.$('input[name=payment\\[method\\]]:checked').val() == "sagepaypaypal"  ||
...
//          this.initFbApp();
    ...
    OneStep.Plugins.SagepayServer           = Backbone.View.extend({
        ...
        beforePostToGateway: function(){
            /* Fix Ebizmart Sagepay */
            var params = {updatebillingaddress: true, updateshippingaddress: true, updateshippingtype: true, updatepaymentmethod: true, updateshippingmethod: true};
            view_onestep_init.update(params);
            /* Fix Ebizmart Sagepay */
